<?php
    ...
    class StudentDao {
        ...
        private $passwd = "root"; //your mysql password
        ...
        public function deleteById($noCarte) {
            ...
            $stmt = $mysqli->prepare("delete from formation where noCarte=?");
            
            $stmt->bind_param('i', $noCarte);
            
            $stmt->execute();
            
            $stmt2 = $mysqli->prepare("delete from etu where noCarte=?");
            
            $stmt2->bind_param('i', $noCarte);
