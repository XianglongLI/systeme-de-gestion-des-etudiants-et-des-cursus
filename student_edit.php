    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper" >
            <div id="page-inner">
                ...
                <form method='post' action='./action.inc/studentAction.php?action=edit'>
                    <div class='row'>
                    ...
                    <div class='row'>
                        <div class='col-md-offset-2'>
                            ...
                            <a href="action.inc/studentAction.php?action=delete&noCarte=<?php echo $noCarte; ?>" onclick="return confirm('Vous voulez vraiment supprimer cet étudiant et tous ses cursus?')" class="btn btn-danger"><span class="glyphicon glyphicon-remove" aria-hidden="true"> Supprimer cet étudiant</a>
                        </div>
                    </div>
                </form>
    </div>
